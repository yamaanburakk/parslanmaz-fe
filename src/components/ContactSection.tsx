        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+905412288366" className="text-primary-500 hover:text-primary-600">
                      +90 541 228 83 66
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@parslanmaz.com" className="text-primary-500 hover:text-primary-600">
                      info@parslanmaz.com
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
              <h4 className="font-semibold text-gray-900 mb-2">Hızlı İletişim</h4>
