    ...
    <section className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 text-primary-100 leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a 
              ...
              className="bg-gradient-to-r from-accent-500 to-accent-600 text-white px-10 py-4 rounded-xl font-semibold text-lg hover:from-accent-600 hover:to-accent-700 transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl inline-flex items-center gap-2"
            >
            ...
            <button className="border-2 border-white/30 text-white px-10 py-4 rounded-xl font-semibold text-lg hover:bg-white/10 hover:border-white/50 transition-all duration-300 backdrop-blur-sm inline-flex items-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-primary-200 text-sm">Mutlu Müşteri</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-accent-400 mb-2">1000+</div>
              <div className="text-primary-200 text-sm">Tamamlanan Proje</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-accent-400 mb-2">15+</div>
              <div className="text-primary-200 text-sm">Yıllık Tecrübe</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-accent-400 mb-2">50+</div>
              <div className="text-primary-200 text-sm">Ülkeye İhracat</div>
            </div>
          </div>
        </div>
      </div>
