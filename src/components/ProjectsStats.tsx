                ...
                {sectors.map((sector, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    <div className="flex-1 bg-gray-200 rounded-full h-4 mr-4">
                      <div
                        className="bg-gradient-to-r from-primary-500 to-accent-500 h-4 rounded-full transition-all duration-1000"
                ...
                <div className="bg-gradient-to-r from-primary-50 to-accent-50 p-6 rounded-xl">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">İhtiyaç Analizi</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-primary-500 rounded-full mr-3"></div>
                      <span className="text-sm text-gray-600">Tasarım & Planlama</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-primary-500 rounded-full mr-3"></div>
                      <span className="text-sm text-gray-600">Üretim & Kalite Kontrol</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-primary-500 rounded-full mr-3"></div>
                      <span className="text-sm text-gray-600">Kurulum & Teslimat</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-gradient-to-r from-accent-50 to-primary-50 p-6 rounded-xl">
                  <h4 className="text-lg font-semibold text-gray-900 mb-3">
                    Kalite Garantisi
                  </h4>
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">5 Yıl Garanti</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-accent-500 rounded-full mr-3"></div>
                      <span className="text-sm text-gray-600">7/24 Teknik Destek</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-accent-500 rounded-full mr-3"></div>
                      <span className="text-sm text-gray-600">ISO 9001 Sertifikası</span>
                    </div>
                  </div>
                </div>
              </div>
