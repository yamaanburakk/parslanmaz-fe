      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center bg-gradient-to-r from-[#60A5FA]/20 to-[#9CA3AF]/20 backdrop-blur-md rounded-full px-6 py-3 mb-8 border border-[#60A5FA]/40 shadow-xl">
            <span className="text-white text-sm font-bold tracking-wide">Sıkça Sorulan Sorular</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Endüstriyel Mutfakta
            <span className="block bg-gradient-to-r from-[#60A5FA] via-[#9CA3AF] to-[#64748B] bg-clip-text text-transparent">Uzman Çözümler</span>
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 leading-relaxed font-medium">
            Paslanmaz çelik ekipmanlarınız hakkında merak ettiğiniz her şey için 
            <span className="text-[#60A5FA] font-bold"> kapsamlı rehberimiz</span> ve 
            <span className="text-[#60A5FA] font-bold"> uzman desteğimiz</span> burada.
          </p>
        </div>
      </div>
