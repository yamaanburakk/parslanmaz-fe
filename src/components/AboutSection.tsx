    ...
    <section id="about" className="py-20 bg-gradient-to-br from-primary-50 to-accent-50/30">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-700 leading-relaxed mb-12 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-primary-100 hover:border-accent-200 group">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-100 to-accent-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-primary-800 mb-4 group-hover:text-accent-700 transition-colors">Kalite Garantisi</h3>
              <p className="text-primary-600 leading-relaxed">
                Tüm ürünlerimizde yüksek kalite standartları ve uzun ömür garantisi sunuyoruz.
              </p>
              <div className="mt-4 w-12 h-1 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full group-hover:w-16 transition-all duration-300"></div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-primary-100 hover:border-accent-200 group">
              ...
              <h3 className="text-xl font-semibold text-primary-800 mb-4 group-hover:text-accent-700 transition-colors">Hızlı Teslimat</h3>
              <p className="text-primary-600 leading-relaxed">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-primary-100 hover:border-accent-200 group">
              ...
              <h3 className="text-xl font-semibold text-primary-800 mb-4 group-hover:text-accent-700 transition-colors">7/24 Destek</h3>
              <p className="text-primary-600 leading-relaxed">
