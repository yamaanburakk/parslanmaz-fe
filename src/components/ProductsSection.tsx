    ...
    <section id="products" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-primary-600 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {productCategories.map((product, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-white to-primary-50/50 p-6 sm:p-8 rounded-xl hover:shadow-xl transition-all duration-300 cursor-pointer group border border-primary-100 hover:border-accent-200"
            >
              ...
              <button className="text-sm sm:text-base text-accent-600 font-semibold hover:text-accent-700 transition-colors inline-flex items-center gap-2 group-hover:gap-3">
                Detayları Gör 
                <svg className="w-3 h-3 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </button>
              <div className="mt-3 sm:mt-4 w-0 h-0.5 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full group-hover:w-full transition-all duration-300"></div>
            </div>
          ))}
        </div>

        <div className="text-center mt-12 sm:mt-16">
          <button className="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:from-primary-700 hover:to-primary-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center gap-2">
